...
```{r nn}
set.seed(42)
algae_model <- neuralnet(~bluegreen_algae_conc_.ug.L.~., data=algae_norm, hidden= c(10,6))
plot(algae_model)
...
train_dat2.Y <- algae_sub[train_set_ind , 3]  # Outcome "survived" column:8

test_dat2.X <- dat2.norm[-train_set_ind, ]
test_dat2.Y <- algae_sub[-train_set_ind , 3]  # Outcome "survived" column:8
